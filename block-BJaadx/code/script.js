...
li.innerText="all about DOM"
//    - Select the input element with name `email`
let mail = document.body.children[6].children['email']
// 3. Log the number (using console.log) of children of all the `li` element inside the ul with class `topics`
let liLen=document.querySelectorAll(".topics li")
console.log(liLen.length)
// 4. Select the first input using the `type` selector and store them in variable named `emailInput`
let emailType= document.querySelector('[type="email"]')
...
allTopics.forEach((liText)=>console.log(liText.innerText))
...
let allButtons = document.querySelectorAll('button').length
console.log(allButtons)
// 18. Select all the `label` element and log the count.
console.log(document.querySelectorAll('label').length)
// 19. Select all the elements with `id` of `test`
let allIdTest = document.querySelectorAll('#test')
// 20. Select the first element with id `test` using `getElementById`
let firstIdTest = document.getElementById('test')
// 21. Select the parent element of the element stored in `topics` variable (#5) and log the element.
let  parentElement = topics.parentElement;
console.log(parentElement);
// 22. Select the next element sibling of the element stored in `topics` variable (#5) and log the element.
let nextElementSibling = topics.nextElementSibling;
console.log(nextElementSibling)
// 23. Select the previous element sibling of the element stored in `topics` variable (#5) and change the `innerText` property to `Learning About Walking the DOM`.
let previousElementSibling = topics.previousElementSibling;
console.log(previousElementSibling)
// 24. Select the first element child of the element stored in `topics` variable (#5) and change the `innerText` property of the element to `This is the first child element`.
let firstElementChild = topics.firstElementChild;
console.log(firstElementChild)
// 25. Select the last element child of the element stored in `topics` variable (#5) and log the `typeof` the element.
let lastElementChild = topics.lastElementChild;
